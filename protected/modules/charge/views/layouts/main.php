            ...
            <div class="main-container-inner">
                ...
                <div class="sidebar" id="sidebar">
                    ...
                    <ul class="nav nav-list">
                        ...
                        <li <?php if (in_array($controller_id, array('area','place'))): ?>class="active open"<?php endif; ?>>
                            <a href="#" class="dropdown-toggle">
                                <i class="icon-edit"></i>
                                <span class="menu-text"> 采价点管理 </span>
                                <b class="arrow icon-angle-down"></b>
                            </a>
                            <ul class="submenu">
                                <li <?php if ($controller_id == 'area'): ?>class="active"<?php endif; ?>>
                                    <a <?php if ($controller_id == 'area'): ?>class="active"<?php endif; ?> href="<?php echo $this->createUrl('/admin/area') ?>">
                                        <i class="icon-double-angle-right"></i>
                                        地区管理
                                    </a>
                                </li>
                                <li <?php if ($controller_id == 'place'): ?>class="active"<?php endif; ?>>
                                    <a <?php if ($controller_id == 'place'): ?>class="active"<?php endif; ?> href="<?php echo $this->createUrl('/admin/place') ?>">
                                        <i class="icon-double-angle-right"></i>
                                        采价点管理
                                    </a>
                                </li>
                        ...
                        <li <?php if (in_array($controller_id, array('depart','user','charge'))): ?>class="active open"<?php endif; ?>>
                            <a href="#" class="dropdown-toggle">
                                <i class="icon-edit"></i>
                            ...
                            <ul class="submenu">
                                ...
                                <li <?php if ($controller_id == 'depart'): ?>class="active"<?php endif; ?>>
                                    <a <?php if ($controller_id == 'depart'): ?>class="active"<?php endif; ?> href="<?php echo $this->createUrl('/admin/depart') ?>">
                                        <i class="icon-double-angle-right"></i>
                                        主管部门管理
                                    </a>
                                </li>
                                <li <?php if ($controller_id == 'charge'): ?>class="active"<?php endif; ?>>
                                    <a <?php if ($controller_id == 'charge'): ?>class="active"<?php endif; ?> href="<?php echo $this->createUrl('/admin/charge') ?>">
                                        <i class="icon-double-angle-right"></i>
                                        主管成员管理
                                    </a>
                                </li>
                        ...
                        <li <?php if (in_array($controller_id, array('goods_category','goods','project'))): ?>class="active open"<?php endif; ?>>
                            <a href="#" class="dropdown-toggle">
                                <i class="icon-edit"></i>
                            ...
                            <ul class="submenu">
                                <li <?php if ($controller_id == 'goods_category'): ?>class="active"<?php endif; ?>>
                                    <a <?php if ($controller_id == 'goods_category'): ?>class="active"<?php endif; ?> href="<?php echo $this->createUrl('/admin/goodscategory') ?>">
                                        <i class="icon-double-angle-right"></i>
                                        分类管理
                                    </a>
                                </li>
                                ...
                                <li <?php if ($controller_id == 'project'): ?>class="active"<?php endif; ?>>
                                    <a <?php if ($controller_id == 'project'): ?>class="active"<?php endif; ?> href="<?php echo $this->createUrl('/admin/project') ?>">
                                        <i class="icon-double-angle-right"></i>
                                        项目管理
                                    </a>
                                </li>
                        ...
                        <li <?php if (in_array($controller_id, array('announce'))): ?>class="active open"<?php endif; ?>>
                            <a href="#" class="dropdown-toggle">
                                <i class="icon-edit"></i>
                            ...
                            <ul class="submenu">
                                <li <?php if ($controller_id == 'announce'): ?>class="active"<?php endif; ?>>
                                    <a <?php if ($controller_id == 'announce'): ?>class="active"<?php endif; ?> href="<?php echo $this->createUrl('/admin/announce') ?>">
                                        <i class="icon-double-angle-right"></i>
                                        公告管理
                                    </a>
                                </li>
